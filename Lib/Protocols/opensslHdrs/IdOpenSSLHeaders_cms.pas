...
begin
  ...
  FuncLoaded := assigned(CMS_get0_type);
  ...
  FuncLoaded := assigned(CMS_dataInit);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_dataFinal);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_get0_content);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_is_detached);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_set_detached);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_stream);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(d2i_CMS_bio);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(i2d_CMS_bio);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(BIO_new_CMS);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(i2d_CMS_bio_stream);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(PEM_write_bio_CMS_stream);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(SMIME_read_CMS);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(SMIME_write_CMS);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_data_create);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_digest_verify);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_digest_create);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_EncryptedData_decrypt);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_EncryptedData_encrypt);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_EncryptedData_set1_key);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_decrypt);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_decrypt_set1_pkey);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_decrypt_set1_key);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_decrypt_set1_password);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_type);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_get0_pkey_ctx);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_EnvelopedData_create);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add1_recipient_cert);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_set0_pkey);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_ktri_cert_cmp);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_ktri_get0_algs);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_ktri_get0_signer_id);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add0_recipient_key);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_kekri_get0_id);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_set0_key);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_kekri_id_cmp);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_set0_password);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add0_recipient_password);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_decrypt);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_encrypt);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_uncompress);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_compress);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_set1_eContentType);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_get0_eContentType);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add0_CertificateChoices);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add0_cert);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add1_cert);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add0_RevocationInfoChoice);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add0_crl);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add1_crl);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignedData_init);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add1_signer);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_get0_pkey_ctx);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_get0_md_ctx);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_set1_signer_cert);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_get0_signer_id);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_cert_cmp);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_get0_algs);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_get0_signature);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_sign);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_verify);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SignerInfo_verify_content);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_get_attr_count);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_get_attr_by_NID);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_get_attr_by_OBJ);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_get_attr);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_delete_attr);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_add1_attr);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_add1_attr_by_OBJ);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_add1_attr_by_NID);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_add1_attr_by_txt);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_signed_get0_data_by_OBJ);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_get_attr_count);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_get_attr_by_NID);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_get_attr_by_OBJ);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_get_attr);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_delete_attr);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_add1_attr);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_add1_attr_by_OBJ);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_add1_attr_by_NID);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_add1_attr_by_txt);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_unsigned_get0_data_by_OBJ);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_get1_ReceiptRequest);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_add1_ReceiptRequest);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_kari_get0_orig_id);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_kari_orig_id_cmp);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientEncryptedKey_get0_id);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientEncryptedKey_cert_cmp);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_kari_set0_pkey);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_kari_get0_ctx);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_RecipientInfo_kari_decrypt);
  if not FuncLoaded then
  begin
  ...
  FuncLoaded := assigned(CMS_SharedInfo_encode);
  if not FuncLoaded then
  begin
