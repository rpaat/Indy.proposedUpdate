...
{$WARN  NO_RETVAL OFF}
function  ERR_ERR_load_SSL_strings: TIdC_INT; 
begin
  EIdAPIFunctionNotPresent.RaiseException(ERR_load_SSL_strings_procname);
end;
...
begin
  ...
  FuncLoaded := assigned(ERR_load_SSL_strings);
